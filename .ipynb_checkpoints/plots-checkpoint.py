...
def plot_one_intervention_horizontal(column,baseline,one_intervention_dict,camp_name):
...
def plot_one_intervention_horizontal_interactive(plot_one_intervention_horizontal,baseline,camp_name):
...
def plot_one_intervention_vertical(column,one_intervention_dict,camp_name,top_5=False):
    intervention_dict=load_intervention_dict(camp_name)
    peak_values={}
    for key,value in one_intervention_dict.items():
...
def plot_one_intervention_vertical_interactive(plot_one_intervention_vertical,camp_name):
    folder_path=os.path.join('model_outcomes',camp_name,'one_intervention')
    one_intervention_dict=load_interventions(folder_path,camp_name)
...
def plot_intervention_comparison_interactive(plot_intervention_comparison,baseline,camp_name):
    folder_path=os.path.join('model_outcomes',camp_name,'one_intervention')
...
def plot_custom_intervention_comparison_interactive(plot_intervention_comparison,baseline,camp_name):
...
def plot_hygiene_intervention_horizontal(baseline,camp_name,column='Infected (symptomatic)',timing=True):
    folder_path=os.path.join('model_outcomes',camp_name,'one_intervention')
    if timing:
        ...
        return plot_one_intervention_horizontal(column,baseline,selectedInterventions,camp_name)
    else:
...
def plot_iso_intervention_horizontal(baseline,camp_name,column='Infected (symptomatic)',timing=True):
    folder_path=os.path.join('model_outcomes',camp_name,'one_intervention')
    if timing:
...
def plot_onetype_intervention_horizontal(baseline,prefix,camp_name,column='Infected (symptomatic)'):
    folder_path=os.path.join('model_outcomes',camp_name,'one_intervention')
    selectedInterventions=load_interventions(folder_path,camp_name,prefix=prefix)
    return plot_one_intervention_horizontal(column,baseline,selectedInterventions,camp_name)
    
def plot_onetype_intervention_vertical(prefix,camp_name,column='Infected (symptomatic)',top_5=False):
    folder_path=os.path.join('model_outcomes',camp_name,'one_intervention')
    selectedInterventions=load_interventions(folder_path,camp_name,prefix=prefix)
    return plot_one_intervention_vertical(column,selectedInterventions,camp_name,top_5=top_5)
